...
****Добавлено****
dos_wifi - снижает скорость интернета в локальной сети<br>
sms_bomb - смс-бомбер (работает только на РФ номера)<br>
update - проверка обновления по config.json файлу<br>
test - проверка файлов на правильность (возможно будут ошибки)<br>
read_license - предложение о прочтении лицензии<br>
check_inet - проверка интернета<br>
